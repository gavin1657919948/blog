...
export const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'hosts', loadChildren: '@uranplus/module-alain-host#HostsModule' },
      { path: 'users', loadChildren: '@uranplus/module-alain-user#UsersModule' },
      { path: 'sensors', loadChildren: '@uranplus/module-alain-sensor#SensorsModule' },
      { path: 'map', loadChildren: '@uranplus/module-alain-map#MapModule' },
    ],
  },
