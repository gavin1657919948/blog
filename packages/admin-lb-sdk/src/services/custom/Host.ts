...
/**
 * Api services for the `Host` model.
 *
 * **Details**
 *
 * Host: Manage host machine
 */
@Injectable()
export class HostApi extends BaseLoopBackApi {
  ...
  /**
   * Fetches belongsTo relation installer.
   *
   * @param {any} id Host id
   *
   ...
   * </em>
   */
  public getInstaller(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
  ...
  /**
   * Fetches belongsTo relation maintainer.
   *
   * @param {any} id Host id
   *
   * @param {boolean} refresh 
   ...
   * </em>
   */
  public getMaintainer(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Hosts/:id/maintainer";
    let _routeParams: any = {
   ...
   * </em>
   */
  public getProductModel(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Hosts/:id/productModel";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   *  - `result` – `{string}` - 
   */
  public activate(id: any, data: Location = new Location(), customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Hosts/:id/activate";
    let _routeParams: any = {
