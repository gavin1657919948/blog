 ...
 * **Details**
 *
 * Sensor: Manage sensor
 */
@Injectable()
export class SensorApi extends BaseLoopBackApi {
   ...
   * </em>
   */
  public getHost(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
  ...
  /**
   * Get channelLogs belongsTo sensor by channelLog filter
   *
   * @param {string} sensorId Sensor Id
   *
   * @param {object} Filter ChannelLog Filter defining fields, where, include, order, offset, and limit - must be a JSON-encoded string ({"something":"value"})
   *
   * @param {any} id 
   *
   * @returns {object[]} An empty reference that will be
   ...
   * </em>
   */
  public channelLogs(sensorId: any = {}, Filter: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Sensors/:id/channelLogs";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    if (typeof sensorId !== 'undefined' && sensorId !== null) _urlParams.sensorId = sensorId;
    if (typeof Filter !== 'undefined' && Filter !== null) _urlParams.Filter = Filter;
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
    return result;
  }
