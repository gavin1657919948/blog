...
export class SystemUserApi extends BaseLoopBackApi {
   ...
   * @param {any} id SystemUser id
   *
   * @param {any} fk Foreign key for hosts
   *
   * @returns {object} An empty reference that will be
   *   populated with the actual data once the response is returned
   *   from the server.
   ...
   * </em>
   */
  public findByIdHosts(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Users/:id/hosts/:fk";
    let _routeParams: any = {
   ...
   * This method returns no data.
   */
  public destroyByIdHosts(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Users/:id/hosts/:fk";
    let _routeParams: any = {
   ...
   * </em>
   */
  public updateByIdHosts(id: any, fk: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "PUT";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Users/:id/hosts/:fk";
    let _routeParams: any = {
  ...
  /**
   * Add a related item by id for hosts.
   *
   * @param {any} id SystemUser id
   *
   * @param {any} fk Foreign key for hosts
   ...
   * </em>
   */
  public linkHosts(id: any, fk: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "PUT";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Users/:id/hosts/rel/:fk";
    let _routeParams: any = {
      id: id,
      fk: fk
    };
  ...
  /**
   * Remove the hosts relation to an item by id.
   *
   * @param {any} id SystemUser id
   *
   * @param {any} fk Foreign key for hosts
   ...
   * This method returns no data.
   */
  public unlinkHosts(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Users/:id/hosts/rel/:fk";
    let _routeParams: any = {
  ...
  /**
   * Check the existence of hosts relation to an item by id.
   *
   * @param {any} id SystemUser id
   *
   * @param {any} fk Foreign key for hosts
   ...
   * </em>
   */
  public existsHosts(id: any, fk: any, customHeaders?: Function): Observable<any> {
   ...
   * @param {any} id SystemUser id
   *
   * @param {any} fk Foreign key for sensors
   *
   * @returns {object} An empty reference that will be
   *   populated with the actual data once the response is returned
   *   from the server.
   ...
   * </em>
   */
  public findByIdSensors(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Users/:id/sensors/:fk";
    let _routeParams: any = {
   ...
   * This method returns no data.
   */
  public destroyByIdSensors(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Users/:id/sensors/:fk";
    let _routeParams: any = {
   ...
   * </em>
   */
  public updateByIdSensors(id: any, fk: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "PUT";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Users/:id/sensors/:fk";
    let _routeParams: any = {
  ...
  /**
   * Add a related item by id for sensors.
   *
   * @param {any} id SystemUser id
   *
   * @param {any} fk Foreign key for sensors
   ...
   * </em>
   */
  public linkSensors(id: any, fk: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "PUT";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Users/:id/sensors/rel/:fk";
    let _routeParams: any = {
      id: id,
      fk: fk
    };
  ...
  /**
   * Remove the sensors relation to an item by id.
   *
   * @param {any} id SystemUser id
   *
   * @param {any} fk Foreign key for sensors
   ...
   * This method returns no data.
   */
  public unlinkSensors(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Users/:id/sensors/rel/:fk";
    let _routeParams: any = {
  ...
  /**
   * Check the existence of sensors relation to an item by id.
   *
   * @param {any} id SystemUser id
   *
   * @param {any} fk Foreign key for sensors
   ...
   * </em>
   */
  public existsSensors(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "HEAD";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Users/:id/sensors/rel/:fk";
    let _routeParams: any = {
   ...
   * </em>
   */
  public getHosts(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Users/:id/hosts";
    let _routeParams: any = {
   ...
   * </em>
   */
  public createHosts(id: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Users/:id/hosts";
    let _routeParams: any = {
   ...
   * This method returns no data.
   */
  public deleteHosts(id: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Users/:id/hosts";
    let _routeParams: any = {
   ...
   *  - `count` – `{number}` - 
   */
  public countHosts(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Users/:id/hosts/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public getSensors(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Users/:id/sensors";
    let _routeParams: any = {
   ...
   * </em>
   */
  public createSensors(id: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Users/:id/sensors";
    let _routeParams: any = {
   ...
   * This method returns no data.
   */
  public deleteSensors(id: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Users/:id/sensors";
    let _routeParams: any = {
   ...
   *  - `count` – `{number}` - 
   */
  public countSensors(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Users/:id/sensors/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public createManyHosts(id: any, data: any[] = [], customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Users/:id/hosts";
    let _routeParams: any = {
   ...
   * </em>
   */
  public createManySensors(id: any, data: any[] = [], customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Users/:id/sensors";
    let _routeParams: any = {
